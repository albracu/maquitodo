...
--
-- Host: localhost    Database: maquitodo
-- ------------------------------------------------------
...
CREATE TABLE `vtiger_accountscf` (
  `accountid` int(19) NOT NULL DEFAULT '0',
  `cf_757` varchar(25) DEFAULT '',
  `cf_759` decimal(26,8) DEFAULT NULL,
  `cf_763` varchar(255) DEFAULT '',
  `cf_765` varchar(255) DEFAULT '',
  `cf_767` varchar(255) DEFAULT '',
  `cf_769` varchar(255) DEFAULT '',
  `cf_771` varchar(255) DEFAULT '',
  `cf_773` varchar(20) DEFAULT '',
  `cf_775` varchar(25) DEFAULT '',
  `cf_777` varchar(3) DEFAULT '0',
  `cf_779` varchar(25) DEFAULT '',
  PRIMARY KEY (`accountid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vtiger_accounttype` VALUES (2,'Proveedor',1,2,3),(4,'Customer',1,4,1),(9,'Prospect',1,9,2);
...
INSERT INTO `vtiger_cf_751` VALUES (1,'Propia',1,1),(2,'Renta',2,1);
...
--
-- Table structure for table `vtiger_cf_763`
--

DROP TABLE IF EXISTS `vtiger_cf_763`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_763` (
  `cf_763id` int(11) NOT NULL AUTO_INCREMENT,
  `cf_763` varchar(200) NOT NULL,
  `sortorderid` int(11) DEFAULT NULL,
  `presence` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`cf_763id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_763`
--

LOCK TABLES `vtiger_cf_763` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_763` DISABLE KEYS */;
INSERT INTO `vtiger_cf_763` VALUES (1,'Crédito',1,1),(2,'Contado',2,1);
/*!40000 ALTER TABLE `vtiger_cf_763` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vtiger_cf_763_seq`
--

DROP TABLE IF EXISTS `vtiger_cf_763_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_763_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_763_seq`
--

LOCK TABLES `vtiger_cf_763_seq` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_763_seq` DISABLE KEYS */;
INSERT INTO `vtiger_cf_763_seq` VALUES (2);
/*!40000 ALTER TABLE `vtiger_cf_763_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `vtiger_cf_765`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_765` (
...
LOCK TABLES `vtiger_cf_765` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_765` DISABLE KEYS */;
INSERT INTO `vtiger_cf_765` VALUES (1,'Contra entrega',1,1),(2,'30 días',2,1),(3,'45 días',3,1),(4,'60 días',4,1),(5,'90 días',5,1),(6,'Cheque postfechado a 30 días',6,1),(7,'Cheque postfechado a 45 días',7,1),(8,'Cheque postfechado a 60 días',8,1),(9,'Cheque postfechado a 90 días',9,1);
/*!40000 ALTER TABLE `vtiger_cf_765` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `vtiger_cf_765_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_765_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `vtiger_cf_765_seq` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_765_seq` DISABLE KEYS */;
INSERT INTO `vtiger_cf_765_seq` VALUES (9);
/*!40000 ALTER TABLE `vtiger_cf_765_seq` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vtiger_cf_767`
--

DROP TABLE IF EXISTS `vtiger_cf_767`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_767` (
  `cf_767id` int(11) NOT NULL AUTO_INCREMENT,
  `cf_767` varchar(200) NOT NULL,
  `sortorderid` int(11) DEFAULT NULL,
  `presence` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`cf_767id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_767`
--

LOCK TABLES `vtiger_cf_767` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_767` DISABLE KEYS */;
INSERT INTO `vtiger_cf_767` VALUES (1,'No',1,1),(2,'No aplica',2,1),(3,'Discrecionales',3,1),(4,'Nominativos',4,1);
/*!40000 ALTER TABLE `vtiger_cf_767` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vtiger_cf_767_seq`
--

DROP TABLE IF EXISTS `vtiger_cf_767_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_767_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_767_seq`
--

LOCK TABLES `vtiger_cf_767_seq` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_767_seq` DISABLE KEYS */;
INSERT INTO `vtiger_cf_767_seq` VALUES (4);
/*!40000 ALTER TABLE `vtiger_cf_767_seq` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vtiger_cf_769`
--

DROP TABLE IF EXISTS `vtiger_cf_769`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_769` (
  `cf_769id` int(11) NOT NULL AUTO_INCREMENT,
  `cf_769` varchar(200) NOT NULL,
  `sortorderid` int(11) DEFAULT NULL,
  `presence` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`cf_769id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_769`
--

LOCK TABLES `vtiger_cf_769` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_769` DISABLE KEYS */;
INSERT INTO `vtiger_cf_769` VALUES (1,'Transferencia',1,1),(2,'Cheque',2,1),(3,'Consignación',3,1);
/*!40000 ALTER TABLE `vtiger_cf_769` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vtiger_cf_769_seq`
--

DROP TABLE IF EXISTS `vtiger_cf_769_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_769_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_769_seq`
--

LOCK TABLES `vtiger_cf_769_seq` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_769_seq` DISABLE KEYS */;
INSERT INTO `vtiger_cf_769_seq` VALUES (3);
/*!40000 ALTER TABLE `vtiger_cf_769_seq` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vtiger_cf_771`
--

DROP TABLE IF EXISTS `vtiger_cf_771`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_771` (
  `cf_771id` int(11) NOT NULL AUTO_INCREMENT,
  `cf_771` varchar(200) NOT NULL,
  `sortorderid` int(11) DEFAULT NULL,
  `presence` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`cf_771id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_771`
--

LOCK TABLES `vtiger_cf_771` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_771` DISABLE KEYS */;
INSERT INTO `vtiger_cf_771` VALUES (1,'Ahorros',1,1),(2,'Corriente',2,1);
/*!40000 ALTER TABLE `vtiger_cf_771` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vtiger_cf_771_seq`
--

DROP TABLE IF EXISTS `vtiger_cf_771_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vtiger_cf_771_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vtiger_cf_771_seq`
--

LOCK TABLES `vtiger_cf_771_seq` WRITE;
/*!40000 ALTER TABLE `vtiger_cf_771_seq` DISABLE KEYS */;
INSERT INTO `vtiger_cf_771_seq` VALUES (2);
/*!40000 ALTER TABLE `vtiger_cf_771_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `vtiger_field_seq` VALUES (780);
...
INSERT INTO `vtiger_language` VALUES (1,'English','en_us','US English','2016-07-16 08:28:37',NULL,1,1),(2,'Brazilian','pt_br','PT Brasil','2016-07-16 08:28:53',NULL,0,1),(3,'J?zyk Polski','pl_pl','J?zyk Polski','2016-07-16 08:28:53',NULL,0,1),(4,'Swedish','sv_se','Swedish','2016-07-16 08:28:58',NULL,0,1),(5,'Spanish','es_es','ES Spanish','2016-07-16 08:28:49',NULL,0,1),(6,'Dutch','nl_nl','NL-Dutch','2016-07-16 08:28:49',NULL,0,1),(7,'Mexican Spanish','es_mx','ES Mexico','2016-07-16 08:28:49',NULL,0,1),(8,'Romana','ro_ro','Romana','2016-07-16 08:28:53',NULL,0,1),(9,'Turkce','tr_tr','Turkce Dil Paketi','2016-07-16 08:28:50',NULL,0,1),(10,'Deutsch','de_de','DE Deutsch','2016-07-16 08:28:50',NULL,0,1),(11,'Italian','it_it','IT Italian','2016-07-16 08:28:50',NULL,0,1),(12,'Pack de langue français','fr_fr','Pack de langue français','2016-07-16 08:28:53',NULL,0,1),(13,'British English','en_gb','British English','2016-07-16 08:28:51',NULL,0,1),(14,'Hungarian','hu_hu','HU Magyar','2016-07-16 08:28:52',NULL,0,1),(15,'Russian','ru_ru','Russian','2016-07-16 08:28:53',NULL,0,1),(16,'Arabic','ar_ae','Arabic','2016-07-16 08:28:58',NULL,0,1);
...
CREATE TABLE `vtiger_leadscf` (
  ...
  `cf_753` varchar(3) DEFAULT '0',
  `cf_755` varchar(25) DEFAULT '',
  PRIMARY KEY (`leadid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vtiger_loginhistory` VALUES (1,'admin','190.156.127.89','2016-07-16 11:29:51','2016-07-16 11:29:06','Signed off'),(2,'admin','190.156.127.89','0000-00-00 00:00:00','2016-07-16 11:30:13','Signed in'),(3,'admin','190.9.201.41','0000-00-00 00:00:00','2016-07-16 18:22:11','Signed in');
...
INSERT INTO `vtiger_module_dashboard_widgets` VALUES (1,57,1,0,'0','false','{\"row\":\"1\",\"col\":\"1\"}'),(3,60,1,0,'0','false','{\"row\":\"2\",\"col\":\"5\"}'),(4,61,1,0,'0','false','{\"row\":\"2\",\"col\":\"5\"}');
...
INSERT INTO `vtiger_organizationdetails` VALUES (1,'Maquitodo S.A.S','','Cali','Valle del Cauca','Colombia','76001000','','','http://www.maquitodo.com.co/','logo.png',NULL,'1234-5678-9012');
...
INSERT INTO `vtiger_users` VALUES (1,'admin','$1$ad000000$Iaf.YM40Lu9uKRtWdZxQM0','d41d8cd98f00b204e9800998ecf8427e','#E6FAD8','Alfredo','Bravo Cuero','','on',1,'','2016-07-16 07:54:33',NULL,NULL,'','','','','','','','yo@alfredobravocuero.co','','','Active','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'mm-dd-yyyy','12','00:00','23:00','This Week','Today','',0,'$1$ad000000$nYTnfhTZRmUP.wQT9y1AE.','1','1 Minute',NULL,'PHP5.3MD5','vmbhdRv3XJFyHueC','bluelagoon','es_es','America/Bogota','123,456,789','.',',','$1.0','','2','1','Sunday','5','5','public','Summary','0','medium',NULL,NULL,0,'1');
...
INSERT INTO `vtiger_wsapp` VALUES (1,'vtigerCRM','5789e22e23362','user');
...
-- Dump completed on 2016-08-02 22:42:22
